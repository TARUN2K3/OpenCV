...
# Putting current date and time on the image at position (400,400) with the defined font, font scale of 2, custom color (245,12,789), thickness of 7, and line type 8
img=cv2.putText(img,str(datetime.datetime.now()),(400,400),font,2,(245,12,789),7,cv2.LINE_8)
